...
import { CpnWraper, Svg, EmployeeService, VietNamPlaces, Roles, GetRoleName, BranchService, TitleApp, UserService } from '../../../refs';

class BranchAddEmployee extends Component {
    state = {
        // NEW || OLD
        tabActive: 'NEW'
    }
...
export default connect(mapStateToProps)(BranchAddEmployee);