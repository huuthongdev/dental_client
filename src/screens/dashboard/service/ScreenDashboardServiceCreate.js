                    ...
                    <div className="cpn-form">
                        ...
                        <Formik
                            ...
                            validationSchema={Yup.object().shape({
                                ...
                                suggestedRetailerPrice: Yup.number().required('Không được để trống'),
                            ...
                            render={props => {
                                const { isSubmitting, isValid, errors, touched, values, setFieldValue, setTouched } = props;
                                    ...
                                    <div className="container-fluid">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className={`form-group ${errors.suggestedRetailerPrice && touched.suggestedRetailerPrice ? 'error' : ''}`}>
                                                    <label>Giá đề xuất:</label><span className="error-message">{errors.suggestedRetailerPrice}</span>
                                                    <CpnCurrencyInput
                                                        subfix="đ"
                                                        value={values.suggestedRetailerPrice}
                                                        onChange={number => setFieldValue('suggestedRetailerPrice', number)}
                                                        onBlur={() => setTouched({ ...touched, suggestedRetailerPrice: true })}
                                                    />
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
