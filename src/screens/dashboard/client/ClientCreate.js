...
import { Svg, CpnWraper, TitleApp, VietNamPlaces, medicalHistoryData, SubmitButtonsGroup, ClientService } from '../../../refs';
...
export default connect(mapStateToProps)(ClientCreate);